...
function Adduser()
{
    const [formValue, setFormValue]= useState({username:'', email:'',phone:'',address:'',status:'', id:''});
    ...
    const handleSubmit= async(e)=>{
       e.preventDefault();
       const uid = uuid()
       const allInputvalue= { username: formValue.username, email:formValue.email, phone:formValue.phone, address:formValue.address, status:formValue.status, id:uid}; 
